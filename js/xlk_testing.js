var pro_span = document.getElementById('pro_span');
(function(window) {
    const l = 42,
        r = 10,
        w = 310,
            ...
            document.addEventListener('mouseup', (e) => {
                ...
                if (spliced) {
                    if (TuringTest) {
                        ...
                        pro_span.innerHTML = '你真棒！';
                        pro_span.style.color = '#00a862';
                    } else {
                    ...
                    pro_span.innerHTML = '请控制拼图块对齐缺口';
                    pro_span.style.color = 'red';
                }
            })
        }
        verify() {
